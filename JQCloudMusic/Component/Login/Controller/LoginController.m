...
//注册
- (void)onRegisterClick:(QMUIButton *)sender{
    [self startController:[RegisterController class]];
}

//忘记密码
- (void)onForgotPasswordViewClick:(QMUIButton *)sender{
    [InputUserIdentityController startWithForgotPassword:self.navigationController];
}
