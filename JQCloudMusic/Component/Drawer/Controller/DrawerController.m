...
-(void)initMessageMenu{
    ...
    //我的消息
    _messgeView = [SuperSettingView smallWithIcon:R.image.message title:R.string.localizable.myMessage click:^(UIView * _Nonnull view) {
        [self closeDrawer];
//        [self loginAfter:^{
//            [self startController:[ConversationController class]];
//        }];
    }];
    //设置红点偏移
    _messgeView.titleView.qmui_badgeOffset = CGPointMake(5, 19);
    [itemContainer addSubview:_messgeView];
    
    //我的好友
    SuperSettingView *itemView = [SuperSettingView smallWithIcon:R.image.friends title:R.string.localizable.myFriend click:^(UIView * _Nonnull view) {
        [self closeDrawer];
//        [self loginAfter:^{
//            [UserController start:[self getNavigationController] style:StyleFriend];
//        }];
    }];
    [itemContainer addSubview:itemView];
    
    //我的粉丝
    itemView = [SuperSettingView smallWithIcon:R.image.fans title:R.string.localizable.myFans click:^(UIView * _Nonnull view) {
        [self closeDrawer];
//        [self loginAfter:^{
//            [UserController start:[self getNavigationController] style:StyleFans];
//        }];
    ...
    itemView = [SuperSettingView smallWithIcon:R.image.scan title:R.string.localizable.myCode click:^(UIView * _Nonnull view) {
        [self closeDrawer];
//        [self loginAfter:^{
//            [self startController:[CodeController class]];
//        }];
    }];
    [itemContainer addSubview:itemView];
}
...
-(void)initShopMenu{
    ...
    SuperSettingView *itemView = [SuperSettingView smallWithIcon:R.image.shop title:R.string.localizable.mall click:^(UIView * _Nonnull view) {
        [self closeDrawer];
//        [self startController:[ProductController class]];
    }];
    [itemContainer addSubview:itemView];
    ...
    itemView = [SuperSettingView smallWithIcon:R.image.scan title:R.string.localizable.myOrder click:^(UIView * _Nonnull view) {
        [self closeDrawer];
//        [self loginAfter:^{
//            [self startController:[OrderController class]];
//        }];
    }];
    [itemContainer addSubview:itemView];
    ...
    itemView = [SuperSettingView smallWithIcon:R.image.shopCart title:R.string.localizable.shopCart click:^(UIView * _Nonnull view) {
        [self closeDrawer];
//        [self loginAfter:^{
//            [self startController:[CartController class]];
//        }];
    }];
    [itemContainer addSubview:itemView];
    ...
    itemView = [SuperSettingView smallWithIcon:R.image.scan title:R.string.localizable.receivingAddress click:^(UIView * _Nonnull view) {
        [self closeDrawer];
//        [self loginAfter:^{
//            [self startController:[AddressController class]];
//        }];
    }];
    [itemContainer addSubview:itemView];
}
...
-(void)initOtherMenu{
    ...
    //设置
    SuperSettingView *itemView = [SuperSettingView smallWithIcon:R.image.setting title:R.string.localizable.setting click:^(UIView * _Nonnull view) {
        [self closeDrawer];
//        [self startController:[SettingController class]];
    }];
    [itemContainer addSubview:itemView];
    
    //深色模式
    itemView = [SuperSettingView smallWithIcon:R.image.mode title:R.string.localizable.darkMode switchChanged:^(UISwitch * _Nonnull view) {
    ...
    //定时关闭
    itemView = [SuperSettingView smallWithIcon:R.image.timer title:R.string.localizable.timedOff click:^(UIView * _Nonnull view) {
        
    }];
    [itemContainer addSubview:itemView];
    
    //个性装扮
    itemView = [SuperSettingView smallWithIcon:R.image.decorate title:R.string.localizable.personDress click:^(UIView * _Nonnull view) {
        
    }];
    [itemContainer addSubview:itemView];
    
    //边听边缓存
    itemView = [SuperSettingView smallWithIcon:R.image.downloadBySound title:R.string.localizable.cacheWhileList click:^(UIView * _Nonnull view) {
    ...
    itemView = [SuperSettingView smallWithIcon:R.image.scan title:R.string.localizable.jsTest click:^(UIView * _Nonnull view) {
        [self closeDrawer];
//        [SuperWebController start:[self getNavigationController] title:@"测试原生和JS交互" uri:@"http://www.ixuea.com/assets/bride.html"];
    }];
    [itemContainer addSubview:itemView];
